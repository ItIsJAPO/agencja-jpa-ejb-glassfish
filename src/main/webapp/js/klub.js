$(document).ready(function()
{
    ...
    doAjax('../rest/klub/getAllKlubs', 'GET', 'JSON', '').success(
           function(response)
           {
    ...
    $('#update-form').submit(function(e)
    {
        ...
        if(idKlub != '' && typeof idKlub != 'undefined' && idKlub == newidKlub)
        {
            ...
            {
                 doAjax('../rest/klub/updateKlub', 'PUT', '', {idKlub:idKlub, miasto: newMiasto, nazwa: newNazwa, ilosc_miejsc: newIlosc_miejsc}).success(
                 function(response)
                 {
                     $('#update-modal').modal('hide');
