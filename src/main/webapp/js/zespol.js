$(document).ready(function()
{
    ...
    doAjax('../rest/zespol/getAllZespols', 'GET', 'JSON', '').success(
           function(response)
           {
    ...
    $("#delete-btn").on('click', function()
    {
        ...
        {
            doAjax('../rest/zespol/deleteZespol', 'DELETE', '', {idZespol: idZespol}).success(function(response){ location.reload(true); });
        }
    });
    ...
    $('#update-form').submit(function(e)
    {
        ...
        if(idZespol != '' && typeof idZespol != 'undefined' && idZespol == newidZespol)
        {
            ...
            {
                 doAjax('../rest/zespol/updateZespol', 'PUT', '', {idZespol:idZespol, nazwa: newNazwa, kraj: newKraj}).success(
                 function(response)
                 {
                     $('#update-modal').modal('hide');
        ...
        $('#add-btn').click(function()
        {
        	...
        	kraj = $('#kraj').val();
        		...
        		doAjax('../rest/zespol/addZespol', 'POST', '', {nazwa: nazwa, kraj: kraj}).success(
                function(response)
                {
                    location.reload(true);
                });;
